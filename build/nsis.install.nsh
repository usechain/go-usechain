Name "used ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/usechain/go-usechain/issues"
!define UPDATEURL "https://github.com/usechain/go-usechain/releases"
!define ABOUTURL "https://github.com/usechain/go-usechain#ethereum-go"
...
# Install used binary
Section "Used" used_IDX
  SetOutPath $INSTDIR
  file {{.Used}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\used.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\used.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Used incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Used outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Used UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Used incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\used.exe" "" "" "Usechain" 30303 "" "" ""
  SimpleFC::AdvAddRule "Used outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\used.exe" "" "" "Usechain" "" 30303 "" ""
  SimpleFC::AdvAddRule "Used UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\used.exe" "" "" "Usechain" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\used.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\used.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${used_IDX}
    SectionGetSize ${used_IDX} $0
