...
import (
	...
	"github.com/usechain/go-usechain/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the Usechain contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the Usechain contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Usechain contract Solidity source to build and bind")
