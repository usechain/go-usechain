...
// setting up a new or managing an existing Usechain private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Usechain private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Usechain network down to  |")
	...
	log.Info("Administering Usechain network", "name", w.network)
