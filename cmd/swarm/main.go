...
import (
	...
	bzzapi "github.com/usechain/go-usechain/swarm/api"
	swarmmetrics "github.com/usechain/go-usechain/swarm/metrics"
...
var (
	...
	SwarmSwapAPIFlag = cli.StringFlag{
		Name:   "swap-api",
		Usage:  "URL of the Usechain API provider to use to settle SWAP payments",
...
var app = utils.NewApp(gitCommit, "Usechain Swarm")
