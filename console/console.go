...
// Welcome show summary of current Used instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Used metadata
	fmt.Fprintf(c.printer, "Welcome to the Used JavaScript console!\n\n")
	c.jsre.Run(`
