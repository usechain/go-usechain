...
func (hc *HeaderChain) ValidateHeaderChain(chain []*types.Header, checkFreq int, state *state.StateDB) (int, error) {
...
// Get ethdb from headerchain
//func (hc *HeaderChain) GetEthdb() ethdb.Database {
//	return hc.chainDb
//}
