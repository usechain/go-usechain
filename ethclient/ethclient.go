...
//
//func (ec *Client) QueryAddrAt(ctx context.Context, addr common.Address) (uint64,error) {
//	var res hexutil.Uint64
//	err := ec.c.CallContext(ctx, &res, "use_queryAddr", addr)
//	return uint64(res),err
//}
//
//func (ec *Client) MinerAddrAt(ctx context.Context, addr common.Address) (uint64,error) {
//	var res hexutil.Uint64
//	err := ec.c.CallContext(ctx, &res, "use_minerAddr", addr)
//	return uint64(res),err
//}
