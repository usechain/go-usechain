...
func TestTxPool(t *testing.T) {
	...
	blockchain, _ := core.NewBlockChain(sdb, nil, params.TestChainConfig, rpow.NewFullFaker(), vm.Config{})
	gchain, _ := core.GenerateChain(params.TestChainConfig, genesis, rpow.NewFaker(), sdb, poolTestBlocks, txPoolTestChainGen)
	...
	lightchain, _ := NewLightChain(odr, params.TestChainConfig, rpow.NewFullFaker())
	txPermanent = 50
