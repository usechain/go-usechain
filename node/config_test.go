...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "used.ipc", false, filepath.Join(os.TempDir(), "used.ipc")},
		{"data", "used.ipc", false, "data/used.ipc"},
		{"data", "./used.ipc", false, "./used.ipc"},
		{"data", "/used.ipc", false, "/used.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "used.ipc", true, `\\.\pipe\used.ipc`},
		{"data", "used.ipc", true, `\\.\pipe\used.ipc`},
		{"data", `\\.\pipe\used.ipc`, true, `\\.\pipe\used.ipc`},
	}
