...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/used.ipc",
			endpoint:    "/data/testnet/used.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/used.ipc",
			endpoint:    "/data/testnet/used.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/used.ipc",
			endpoint:    "/data/testnet/used.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/used.ipc",
			endpoint:    "/data/testnet/used.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
